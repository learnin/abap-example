CLASS zcl_lrap100_gen_data_00 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_lrap100_gen_data_00 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '00',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zlrap100_atrav00.

    "insert travel demo data
    INSERT zlrap100_atrav00  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZLRAP100_ATRAV{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
